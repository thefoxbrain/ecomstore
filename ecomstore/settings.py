...
DATABASES = {
    'default': {
        ...
        'NAME': 'C:\\websites\\ecomstore\\sqlite.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'thy&^bq_0cg@i7o5x9(as1&-%wy&_l@h(myj(g$2r1bq#3k0i8'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    'C:/websites/ecomstore/templates'
